...
\textcolor{white}{.}\hspace{0.8cm}
{\it Sujet}: High-Contrast Direct Imaging Of Exoplanets And Circumstellar Disks}\\
...
% \textbf{Justin Hom} (PhD, ASU) co-advisor with J. Patience \hfill \textbf{Since 2020}\\
