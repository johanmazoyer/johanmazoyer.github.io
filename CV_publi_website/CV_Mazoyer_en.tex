...
\vspace{0.4cm}
\textbf{ANR} JCJC - 1 Phd \& 1 postdoc - 375 k€ \hfill \textbf{Since 2025}\\ 
...
\vspace{-0.2cm}
\textbf{Franco-Chilean Collaboration Program} \href{https://www.univ-paris13.fr/ecos-sud/}{EcosSud} with {\it Univ de Chile} - 50 k€ /3 yrs \hfill   \textbf{2020}\\ 
...
% \item ``High contrast imaging: from active correction to observation of circumstellar debris disks", LIRA, Paris, FR \textbf{Jan. 2019}
...
% \item Séminaire Haute Résolution angulaire, LIRA, Obs. de Paris, France. ``The self-coherent camera: speckle nulling in polychromatic light for the direct detection of exoplanets" \textbf{Oct. 2013}.
...
% \item Journées des thèses du LIRA, Obs de Paris, France. Deux présentations, en \textbf{Mar. 2012} et \textbf{Apr. 2013}.
