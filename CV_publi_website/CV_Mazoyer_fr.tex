...
\vspace{0.4cm}
\textbf{ANR (PI)} ECHOES-ANR JCJC: 1 thèse \& 1 postdoc - 375 k€ \hfill \textbf{Depuis 2025}\\ 
...
\vspace{-0.2cm}
\textbf{Programme collaboratif Franco-Chilien} \href{https://www.univ-paris13.fr/ecos-sud/}{EcosSud} avec {\it Universidad de Chile}  -- 50 k€/an \hfill   \textbf{2020}\\ %- \$300K/3 yrs
...
Je suis très impliqué dans la vulgarisation scintifiques en France. En plus d'interventions régulières en classe ou grand public, 
...
\begin{itemize} \itemsep -2pt
    ...
    \item[$\bullet$] \textbf{VLT/SPHERE+}: Responsable du groupe de travail \textit{Dark-Hole} \hfill Depuis 2022
...
\vspace{-0.1cm}
\begin{itemize} \itemsep -2pt
    \item[$\bullet$] SOC: Roman coronagraphic instrument summer school \hfill  Nice, 2026
    \item[$\bullet$] SOC: ExoSystèmes 4 \hfill Lyon, 2024 
    \item[$\bullet$] Organizer et SOC: National Capital Area Disks conference \hfill Baltimore 2018
    \item[$\bullet$] Organizer et SOC: Optimal Optical Coronagraphs workshop \hfill  Leiden, 2017
...
\vspace{-0.1cm}
\begin{itemize} \itemsep -2pt
    \item[$\bullet$]{\bf Responsable de l'équipe ``Systèmes Exoplanètaires''} du LIRA \hfill Depuis 2025
    \item[$\bullet$] Participation au {\bf Telescope Allocation Committee} d'Hubble \hfill 2024
    \item[$\bullet$] Comité d'experts du thème transverse ``\textbf{(CET exoplanètes)}'' de l'INSU  \hfill 2023 - 2024
    \item[$\bullet$] Comité Scientifique de l'action Spécifique Haute résolution Angulaire de l'INSU \hfill Depuis 2021
    \item[$\bullet$] \textbf{Peer-review} pour le \textit{AJ}, \textit{A\&A}, \textit{MNRAS}, \textit{PASP} et \textit{JATIS}.
\end{itemize}
...
\textbf{Sophia Stasevic} (PhD, LIRA) co-direction avec A.-M. Lagrange and J. Milli \hfill \textbf{Depuis 2021}\\
