...
\vspace{0.4cm}
\textbf{ANR} JCJC - 1 Phd \& 1 postdoc - 375 k€ \hfill \textbf{Depuis 2025}\\ 

\vspace{-0.2cm}
\textbf{DIM Origins} Fonds pour l'achat de matériel (Spatial light modulator) - 20 k€ \hfill \textbf{2023}\\ 
...
\begin{itemize} \itemsep 5pt
    % \item[$\bullet$]\small Séminaire \textbf{``Haute Résolution Angulaire pour l'Astrophysique" (HRAA)} au LIRA (2020-)
...
% \item ``High contrast imaging: from active correction to observation of circumstellar debris disks", LIRA seminar, Meudon, FR \textbf{Mar. 2019}
...
% \item Journées des thèses du LIRA, Obs de Paris, France. Deux présentations, en \textbf{Mars 2012} et \textbf{Avr. 2013}.
