...
\textbf{Intérêts de recherche:} Instrumentation Optique, Exoplanète, Disques de Débris, Imagerie Directe et Coronographie,
Observation et Caractérisation de Systèmes Extrasolaires\\
...
\vspace{0.4cm}
\textbf{ERC Consolidator Grant \href{https://lira.obspm.fr/erc-echoes}{ECHOES} (PI)} - 2 M\euro \hfill \textbf{Depuis 2026}\\ 

\vspace{-0.2cm}
\textbf{France 2030 \href{https://pepr-origins.fr/projet/advanced-multi-spectral-imaging-using-novel-wavefront-sensors-with-optical-photon-counting-detectors-amino/}{AMINO} (PI)} Appel à projets ouvert du PEPR Origins - 1.2 M\euro \hfill \textbf{Depuis 2026}\\ 

\vspace{-0.2cm}
\textbf{ANR JCJC (PI)} déclinée et remboursée au profit de l'ERC Consolidator Grant - 370 k\euro{} \hfill \textbf{2025}\\ 

\vspace{-0.25cm}
\textbf{\href{https://academiespatiale.fr/index.php/a-propos/porteurs-projet/}{Académie spatiale d'île de France} (PI)} 1/2 bourse thèse de L. Delaye - 60 k\euro/3 ans \hfill \textbf{2025}\\ 

\vspace{-0.25cm}
\textbf{CNES (PI)}  (\href{https://cnes.fr/en/phd-postdoc-grants}{French space agency}) 1/2 bourse thèse de M. Castañeda Medina - 60 k\euro/3 ans \hfill \textbf{2025}\\ 

\vspace{-0.2cm}
\textbf{DIM Origins (PI)} Fonds pour l'achat de matériel (spatial light modulator) - 20 k\euro \hfill \textbf{2023}\\ 

\vspace{-0.2cm}
\textbf{CNES (co-PI)} Bourse CNES d'Iva Laginja - 120 k\euro/2 ans \hfill \textbf{2022}\\ 

\vspace{-0.2cm}
\textbf{Data Intensive Artificial Intelligence (PI)} 1/2 bourse thèse de Y. Gutierrez - 60 k\euro/3 ans \hfill \textbf{2021}\\ 

\vspace{-0.2cm}
\textbf{Programme \href{https://www.univ-paris13.fr/ecos-sud/}{EcosSud} (PI)} Collaboration {\it Universidad de Chile} -- 50 k\euro \hfill   \textbf{2020}\\ %- \$300K/3 yrs

\vspace{-0.2cm}
\textbf{NASA Group Award}: LBTI Hosts Survey Science Team \hfill   \textbf{2020}\\ 

\vspace{-0.2cm}
\textbf{Carl Sagan Fellowship (PI)} (\href{http://www.stsci.edu/stsci-research/fellowships/nasa-hubble-fellowship-program}{NASA Hubble Fellowship Program}) -- 280k\euro/3 ans \hfill   { \bf 2018}\\
...
\vspace{-0.2cm}
\textbf{Prix de thèse CNES} Journées CNES des Jeunes Chercheurs (JC2) \hfill   {\bf 2013}\\

% \vspace{-0.2cm}
% \textbf{Bourse doctorale (PI)} du CNES -- 120 k\euro/3 ans \hfill   { \bf 2011}\\
...
Je suis très impliqué dans la vulgarisation scientifique francophone. En plus d'interventions fréquentes en classe ou grand public, 
...
\textbf{Responsabilités dans des instrument scientifiques:}
\begin{itemize} \itemsep -2pt
    \item[$\bullet$] \textbf{Roman Space Telescope Coronagraph}: Représentant adjoint pour le CNES \hfill Depuis 2023
...
\begin{itemize} \itemsep -2pt
    ...
    \item[$\bullet$] \textbf{Rapporteur} pour \textit{AJ}, \textit{A\&A}, \textit{MNRAS}, \textit{PASP} et \textit{JATIS}.
    \item[$\bullet$] \textbf{Rapporteur} dans 2 commités de thèses (France, Belgique).
\end{itemize}
...
\vspace{-0.2cm}\hrule}
\vspace{0.25cm}
\textbf{Manuela Castañeda Medina} (PhD, ONERA): co-direction avec L. Mugnier \hfill \textbf{Depuis 2026}\\
...
\begin{itemize} \itemsep -2pt
    \item[$\bullet$] Instrumentation for Astronomy (organisation + 10h/an)
    \item[$\bullet$] Detection of Exoplanets (organisation + 15h/an)
\end{itemize}
