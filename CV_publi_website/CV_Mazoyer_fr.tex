...
\vspace{0.4cm}
\textbf{ERC - Consolidator Grant (PI)} \href{https://lira.obspm.fr/erc-echoes}{ECHOES} - 2 M\euro \hfill \textbf{Depuis 2026}\\ 

\vspace{-0.2cm}
\textbf{ANR / PEPR Origins (PI)} \href{https://pepr-origins.fr/projet/advanced-multi-spectral-imaging-using-novel-wavefront-sensors-with-optical-photon-counting-detectors-amino/}{AMINO}  - 1.2 M\euro - 1.2 M\euro \hfill \textbf{Depuis 2026}\\ 

\vspace{-0.2cm}
\textbf{ANR JCJC (PI)} - 370 k\euro (interrompue et remboursée) \hfill \textbf{2025-2026}\\ 
...
\vspace{-0.2cm}
\textbf{Meilleur présentation de thèse} Journées CNES des Jeunes Chercheurs (JC2) \hfill   {\bf 2013}\\
